        ...
        <div class="d-flex justify-content-between align-items-center mb-4 flex-wrap">
            <div>
                <h2 class="mb-0 fw-bold">
                    <i class="fas fa-id-card me-2" style="color:#1ABC9C;"></i> Profil Saya
                </h2>
                <p class="text-muted mt-1">Kelola data akun administrator</p>
            </div>
        </div>
            ...
            <div class="col-md-8 offset-md-2">
                <div class="card shadow-sm border-0 rounded-4 profile-card">
                    <div class="card-header bg-white py-3 rounded-top-4" style="border-bottom: 2px solid #1ABC9C;">
                        <h5 class="mb-0"><i class="fas fa-user-shield me-2" style="color:#1ABC9C;"></i> Data Administrator</h5>
                    </div>
                    <div class="card-body">
                        <!-- Notifikasi -->
                        ...
                        <form action="<?= base_url('index.php/admin/update_profile') ?>" method="post">
                            ...
                            <div class="d-flex justify-content-end gap-2">
                                <a href="<?= base_url('index.php/admin/dashboard') ?>" class="btn btn-secondary btn-back">
...
<style>
/* Hover effect untuk card profile */
.profile-card {
