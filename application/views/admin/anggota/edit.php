                ...
                <div class="card border-0 shadow-lg rounded-4">
                    <div class="card-header text-white rounded-top-4" style="background: linear-gradient(135deg, #2C3E50 0%, #34495E 100%);">
                        <div class="d-flex align-items-center">
                            ...
                            <div>
                                <h4 class="mb-0 fw-bold">Edit Anggota</h4>
                                <p class="mb-0 opacity-75">Perbaharui data anggota perpustakaan</p>
                            </div>
                        </div>
                    </div>
                    <div class="card-body p-4">
                        ...
                        <form action="<?= base_url('index.php/admin/update_anggota/'.$anggota->id) ?>" method="post" id="formEditAnggota">
                            <div class="row">
                                <div class="col-md-6">
                                    <!-- Username -->
                                    <div class="mb-4">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" id="username" name="username" value="<?= $anggota->username ?>" required style="border-color: #d5dbdb;">
                                        </div>
                                    ...
                                    <div class="mb-4">
                                        <label class="form-label fw-bold" style="color: #2C3E50;">
                                            <i class="fas fa-lock" style="color: #1ABC9C;"></i> Password
                                        </label>
                                        <div class="input-group">
                                            <span class="input-group-text bg-light" style="border-color: #d5dbdb;">
                                                <i class="fas fa-key" style="color: #1ABC9C;"></i>
                                            </span>
                                            <input type="password" class="form-control" id="password" name="password" placeholder="Kosongkan jika tidak diubah" style="border-color: #d5dbdb;">
                                            <button class="btn btn-outline-secondary" type="button" id="togglePassword" style="border-color: #d5dbdb;">
                                                <i class="fas fa-eye"></i>
                                            </button>
                                        </div>
                                        <small class="text-muted"><i class="fas fa-info-circle me-1" style="color: #1ABC9C;"></i> Minimal 6 karakter, kosongkan jika tidak ingin mengubah password</small>
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" id="nama_lengkap" name="nama_lengkap" value="<?= $anggota->nama_lengkap ?>" required style="border-color: #d5dbdb;">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <select class="form-select" id="kelas" name="kelas" required style="border-color: #d5dbdb;">
                                                ...
                                                <optgroup label="Kelas X">
                                                    <option value="X AKL" <?= $anggota->kelas == 'X AKL' ? 'selected' : '' ?>>X AKL</option>
                                                    <option value="X PPLG" <?= $anggota->kelas == 'X PPLG' ? 'selected' : '' ?>>X PPLG</option>
                                                    <option value="X TJKT" <?= $anggota->kelas == 'X TJKT' ? 'selected' : '' ?>>X TJKT</option>
                                                    <option value="X MPLB" <?= $anggota->kelas == 'X MPLB' ? 'selected' : '' ?>>X MPLB</option>
                                                </optgroup>
                                                <optgroup label="Kelas XI">
                                                    <option value="XI AKL" <?= $anggota->kelas == 'XI AKL' ? 'selected' : '' ?>>XI AKL</option>
                                                    <option value="XI PPLG" <?= $anggota->kelas == 'XI PPLG' ? 'selected' : '' ?>>XI PPLG</option>
                                                    <option value="XI TJKT" <?= $anggota->kelas == 'XI TJKT' ? 'selected' : '' ?>>XI TJKT</option>
                                                    <option value="XI MPLB" <?= $anggota->kelas == 'XI MPLB' ? 'selected' : '' ?>>XI MPLB</option>
                                                </optgroup>
                                                <optgroup label="Kelas XII">
                                                    <option value="XII AKL" <?= $anggota->kelas == 'XII AKL' ? 'selected' : '' ?>>XII AKL</option>
                                                    <option value="XII PPLG" <?= $anggota->kelas == 'XII PPLG' ? 'selected' : '' ?>>XII PPLG</option>
                                                    <option value="XII TJKT" <?= $anggota->kelas == 'XII TJKT' ? 'selected' : '' ?>>XII TJKT</option>
                                                    <option value="XII MPLB" <?= $anggota->kelas == 'XII MPLB' ? 'selected' : '' ?>>XII MPLB</option>
                                                </optgroup>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <textarea class="form-control" id="alamat" name="alamat" rows="2" required style="border-color: #d5dbdb;"><?= $anggota->alamat ?></textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="tel" class="form-control" id="no_hp" name="no_hp" value="<?= $anggota->no_hp ?>" required style="border-color: #d5dbdb;">
                                        </div>
                            ...
                            <div class="alert border-0 rounded-3 mt-3" style="background: #ECF0F1;">
                                <div class="d-flex">
                                    ...
                                    <div>
                                        <strong class="d-block" style="color: #2C3E50;">Informasi Edit Anggota</strong>
                                        <small class="text-muted">Username bisa diubah, namun pastikan tidak sama dengan anggota lain. Kosongkan password jika tidak ingin mengubahnya.</small>
                                    </div>
                                </div>
                            </div>
...
// Fungsi untuk mengecek username sudah ada atau belum (exclude current user)
const currentUsername = '<?= $anggota->username ?>';
let usernameTimeoutId;
let noHpTimeoutId;

async function cekUsernameEdit(username) {
    if(!username || username.length < 3) return false;
    if(username === currentUsername) return false; // Username sendiri tidak dianggap duplikat
...
// Fungsi untuk mengecek nomor HP sudah ada atau belum (exclude current user)
const currentNoHp = '<?= $anggota->no_hp ?>';

async function cekNoHpEdit(no_hp) {
    if(!no_hp || no_hp.length < 10) return false;
    if(no_hp === currentNoHp) return false; // No HP sendiri tidak dianggap duplikat
...
if(usernameInput) {
    usernameInput.addEventListener('input', async function() {
        ...
        usernameTimeoutId = setTimeout(async () => {
            const exists = await cekUsernameEdit(username);
            if(exists) {
...
if(noHpInput) {
    ...
    noHpInput.addEventListener('input', async function() {
        ...
        noHpTimeoutId = setTimeout(async () => {
            const exists = await cekNoHpEdit(no_hp);
            if(exists) {
...
document.getElementById('formEditAnggota').addEventListener('submit', async function(e) {
    ...
    if(username !== currentUsername) {
        const usernameExists = await cekUsernameEdit(username);
        if(usernameExists) {
    ...
    // Cek nomor HP sudah ada (kecuali no hp sendiri)
    if(noHp !== currentNoHp) {
        const noHpExists = await cekNoHpEdit(noHp);
        if(noHpExists) {
